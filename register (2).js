// Function to select role and show/hide relevant fields
...
document.getElementById('registerForm').addEventListener('submit', function(event) {
    ...
    // Proceed with registration or display a success message
    showSuccessMessage();
});
...
document.getElementById('fingerprintBtn').addEventListener('click', async function() {
    try {
        ...
        if (result.data) {
            ...
            // Encrypt fingerprint data before using or sending
...
// Function to encrypt sensitive data (AES encryption using CryptoJS)
